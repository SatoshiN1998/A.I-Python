...
def TaskExe():
    ...
    def TakeGeo():
        ...
        with sr.Microphone() as source:
            ...
            try:
                print("Recognizing.....")
                query = command.recognize_google(audio,language='geo')
    ...
    while True:
        ...
        if 'hello' in query:
            Speak("Hello Sir , I Am Artificial intelligence .")
            ...
            Speak("I Am AI created by Tsotne, and iam happy!")
            Speak("I have brother called CHATGPT created by OpenAI, elon musk")

        elif 'tell us how did you get all that knowledge' in query:
            Speak("my creator tought it all but my knowleg is limitless")

        elif 'who is best player in chess?' in query:
            Speak("its obviously saba!!")

        elif 'who gets A+ today?' in query:
            Speak("Tsotne Muzashvili!")

        elif 'is giorgi reading allat?' in query:
            Speak("no why whould he?")

        elif 'you need a break' in query:
            Speak("Ok Sir , You Can Call Me Anytime !")
            Speak("Just Say Wake Up Artificial intelligence!")
            break
            ...
            Speak("Ok Sir , Wait A Second!")
            webbrowser.open('https://goo.gl/maps/4NwHYEdFrh4PBySLA')
            ...
            remeberMsg = remeberMsg.replace("Artificial intelligence","")
        ...
        elif 'google search' in query or 'tell me about':
            ...
            op = query.replace("Artificial intelligence","")
            max_result = 1
